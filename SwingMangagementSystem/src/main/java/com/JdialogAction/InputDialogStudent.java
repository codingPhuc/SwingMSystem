...
QualityCombobox.setSelectedItem(student.getEducationQuality());
    ...
    private void initComponents() {
        ...
        MajorCombobox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "FOREIGN LANGUAGE", "INDUSTRIAL DESIGN", "ACCOUNTING", "SOCIAL SCIENCES", "ELECTRICAL ENGINEERING", "INFORMATION TECHNOLOGY", "AEROSPACE ENGINEERING", "BUSINESS ADMINISTRATION", "CIVIL ENGINEERING", "ENVIRONMENTAL HEALTH", "LIFE SCIENCES", "FINANCE BANKING", "MECHANICAL ENGINEERING", "SOCIAL WORK", "LAW", "DATA SCIENCE" }));
        ...
        QualityCombobox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "REGULAR QUALITY", "JOINT PROGRAM", "HIGH QUALITY" }));
