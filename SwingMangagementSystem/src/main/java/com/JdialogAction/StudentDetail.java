...
//     init();
    ...
    private void init() {
       ...
       EQLabel.setText("Quality : "+ student.getEducationQuality());
    ...
    private void initComponents() {
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(425, 518));
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String [] {
                        "STUDENT ID ", " NAME", "ISSUE DATE", "EXPIRED DATE", "GRADE", "ACTION"
                }
        ));
...
//    List<ModelCertificate> certificates = certificateDao.getCertificatesByStudentID(student.getID());
    ...
    private void exportCertificatesToCSV(List<ModelCertificate> certificates ,JFileChooser csvFileChooser) {
        ...
        try (FileWriter csvWriter = new FileWriter(csvFileChooser.getSelectedFile() + ".csv")) {
            // Write CSV header
            csvWriter.append("STUDENT ID,NAME,ISSUE DATE,EXPIRED DATE,GRADE");
            csvWriter.append("\n");
    ...
    private void exportCertificatesToExcel(List<ModelCertificate> certificates, JFileChooser excelFileChooser) {
        ...
        try {
            ...
            excelRow.createCell(3).setCellValue("EXPIRED DATE");
            ...
            for (int i = 0; i < certificates.size(); i++) {
                ...
                // Set Issue Date and EXPIRED Date as Excel date format
    ...
    private void importCertificatesFromExcelFile(File excelFile) {
        ...
        try {
            ...
            for (int row = 1; row <= excelSheet.getLastRowNum(); row++) {
                ...
                String name = excelName != null ? excelName.getStringCellValue().trim() : "";
                ...
                if (excelGrade != null) {
                    if (excelGrade.getCellType() == CellType.STRING) {
                        try {
                            grade = Float.parseFloat(excelGrade.getStringCellValue().trim());
    ...
    private void importCertificatesFromCSVFile(File csvFile) {
        try (BufferedReader br = new BufferedReader(new FileReader(csvFile))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                int expiryDateIndex = findIndex(headers, "EXPIRED DATE");
                int gradeIndex = findIndex(headers, "GRADE");

                // Use the found indices to get the values
                String name = values[nameIndex].trim();
                String issueDateStr = values[issueDateIndex].trim();
                String expiryDateStr = values[expiryDateIndex].trim();

                float grade = Float.parseFloat(values[gradeIndex].trim());
