...
//        super(text);
//        Font largerFont = getFont().deriveFont(16f); // Change 16f to your desired font size
//    setFont(largerFont);
        ...
        setIcon(icon); // Use the original icon if it's not an ImageIcon
         }
        init();
        setIconTextGap(25);
    ...
    private void init() {
        ...
        TimingTarget target = new TimingTargetAdapter() {
            ...
            public void timingEvent(float fraction) {
                ...
                animatSize = (float) (fraction * targetSize);
                repaint();
            }
