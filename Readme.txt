...
Click "Go" to import the SQL file. This will automatically execute all the SQL commands in the file, creating the necessary tables and inserting the admin user.
...
Locate the ConnectionConfig file.

Open the connection config file and change the connection string to your specific configuration:
